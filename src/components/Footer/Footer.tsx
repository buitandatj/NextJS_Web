...
const Footer = () => {
    return (
        <footer className='footer bg-[#a6a6a6] min-h-[250px] text-white flex items-center'>
            <div className="footer_main container m-auto flex gap-32 justify-center items-center">
                <div className="main_right text-4xl flex flex-col gap-12 ">
                ...
                <div className="main_center flex flex-col gap-2">
                ...
                <div className="main_left flex flex-col gap-6">
